...
module.exports = {
  ...
  elements: {
        ...
        /** Department registration */ 
          ...
          country: `select[id="country_inp"]`,
          country_timezome: `select[id="timezone_inp"]`,
  ...
  commands: [{
    ...
    CreatCompany: function() {
      ...
      const page = this;
                ...
                page.pause(1000)
                page.setValue(`@SupervisorNametxtField`,`Fidel`)
                page.pause(1000)
                page.click(`@SupervisorLastNametxtField`)
                page.pause(1000)
                page.setValue(`@SupervisorLastNametxtField`,`Vergara`)
                page.pause(1000)
                page.click(`@SupervisorEmailtxtField`)
                page.setValue(`@SupervisorEmailtxtField`, access.userCredential.clientEmail)
                page.pause(1000)
                ...
                page.pause(1000)
                page.setValue(`@companyNametxtField`,`GabTestComp`)
                page.pause(1000)
                page.setValue(`@country`,`US: United States of America`)
                page.pause(1000)
                page.setValue(`@country_timezome`,`America/Cambridge_Bay`)
                page.pause(1000)
    ...
    CreateDepartment: function() {
        ...
        const page = this;
                ...
                page.pause(300)
                page.setValue(`@newDeptNametxtField`,department())
                page.pause(300)
